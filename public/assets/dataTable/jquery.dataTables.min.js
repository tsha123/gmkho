...
sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ -> _END_ của _TOTAL_",sInfoEmpty:"Hiển thị 0 -> 0 của toàn bộ",sInfoFiltered:"(đã lọc trong _MAX_ kết quả)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",

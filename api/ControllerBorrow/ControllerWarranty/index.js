            ...
            for(let i =0;i<data.length;i++){
                ...
                if(dataExport){
                    for(let j =0;j<dataExport.export_form_product.length;j++){
                        if(dataExport.export_form_product[j].id_product.toString() == data[i].id_product.toString()){
                            data[i].product_warranty = dataExport.export_form_product[j].product_warranty

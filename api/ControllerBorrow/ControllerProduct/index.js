...
export const getInfo = (app) => {
    app.get(prefixApi, helper.authenToken, async (req, res) => {
        try {
            ...
            console.log("Lỗi 105")
            if (dataProduct.id_export_form && validator.ObjectId.isValid(dataProduct.id_export_form)) {
                // console.log()
                ...
                if (dataExport) {
                    for (let i = 0; i < dataExport.export_form_product.length; i++) {
                        ...
                        if (dataExport.export_form_product[i].id_product.toString() == dataProduct._id.toString()) {
                            ...
                            if (dataExport.export_form_product[i].id_employee && validator.ObjectId.isValid(dataExport.export_form_product[i].id_employee)) {
                            ...
                            if (dataExport.export_form_product[i].id_employee_setting && validator.ObjectId.isValid(dataExport.export_form_product[i].id_employee_setting)) {
                ...
                },
                {
                    $match: {
                        ...
                        $and: [
                            ...
                            { export_form_type: { $ne: validator.TYPE_EXPORT_SEPARATION } },
                        ]
                    }
                },
                {
